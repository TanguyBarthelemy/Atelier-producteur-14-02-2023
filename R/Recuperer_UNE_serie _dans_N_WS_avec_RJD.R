...
summary_ws <- data.frame(
    ...
    path_xml = c(ch_1, ch_2, ch_3, ch_4),
...
for (i in summary_ws$num_ws) {
    ...
    # Regresseurs cjo
    regs_cjo_ts <- model_sa$regarima$specification$
        regression$userdef$variables$serie
